export const chatbotKnowledge = [
  ...
  { keywords: ['budget', 'cost', 'money', 'lkr', 'predict'], answer: 'Set your total budget first, then allocate by category: venue 30–40%, catering 20–25%, photography 10–15%, attire 8–10%. On Budget, run AI cost prediction — it uses a Random Forest model from your guest count, district, ceremony, scale, and wedding season.' },
  ...
  { keywords: ['vendor', 'venue', 'cater', 'photography', 'bridal', 'jewellary', 'floral', 'cake'], answer: 'Browse vendors by category: Venue & Res. Halls, Bridal Service, Groom service, Photography & Videography, Jewellary, Floral & Deco, Caters, and Cakes. Filter by district and send booking requests early.' },
  ...
  { keywords: ['christian', 'church', 'civil', 'muslim', 'nikah', 'hindu', 'tamil', 'reception'], answer: 'WowWed supports Poruwa Ceremony (Sinhalese/Buddhist), Church Wedding (Christian/Western), Hindu Tamil Wedding, Muslim Nikah Ceremony, and Reception. Your checklist and vendor recommendations adapt to your selected ceremony type.' },
