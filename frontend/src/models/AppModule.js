...
const moduleData = [
  ...
  new AppModule({
    ...
    code: 'M16',
    name: 'Assistant',
    tagline: 'Offline planning help for checklists, ceremonies, vendors, and budgeting',
    description: 'Knowledge-base chatbot — Poruwa tips, budget advice, and vendor guidance without an internet API.',
    icon: 'assistant',
    route: '/dashboard/assistant',
    accent: '#fff0e8',
    ring: '#e8a88c',
    showInNav: true,
    hint: 'Ask about Sri Lankan wedding planning',
  }),
  new AppModule({
    id: 'crew',
    code: null,
  ...
  new AppModule({
    ...
    tagline: 'Random Forest estimate in LKR based on guests, district, ceremony, and scale',
    description: 'Predicts wedding cost with confidence interval — standard, premium, or luxury scale.',
    icon: 'ai',
    tone: 'sage',
    smartHighlight: true,
  }),
