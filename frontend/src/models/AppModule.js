...
const moduleData = [
  ...
  new AppModule({
    ...
    tagline: 'Cost prediction from guests, location, and style',
    description: 'A likely total in LKR from guests, district, and style.',
    icon: 'ai',
    tone: 'sage',
    smartHighlight: true,
  }),
  new AppModule({
    ...
    code: 'M09',
    name: 'Vendor Match',
    tagline: 'Rule-based ranking by budget, district, and wedding type',
    description: 'Filters to vendors that match all three criteria, then ranks them on the vendor search screen.',
    icon: 'sparkle',
    tone: 'sage',
    smartHighlight: true,
  }),
