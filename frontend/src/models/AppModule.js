...
const moduleData = [
  new AppModule({
    ...
    code: 'M03',
    name: 'Home',
    tagline: 'Countdown, readiness score, and quick access to all tools',
  ...
  new AppModule({
    ...
    code: 'M08',
    name: 'Requests',
    tagline: 'Track vendor replies and confirm the vendors you want to hire',
    description: 'See pending, accepted, and rejected requests. Confirm hire to add the cost to your budget.',
    icon: 'calendar',
    route: '/dashboard/bookings',
    accent: '#f0f4f8',
    ring: '#7a9eb8',
    showInNav: true,
    hint: 'Vendor replies and hire confirmations',
  }),
  new AppModule({
    id: 'analytics',
    code: 'M13',
  ...
  new AppModule({
    ...
    code: 'M16',
    name: 'Assistant',
    tagline: 'Offline chatbot',
    description: 'Built-in helper with a fixed knowledge base. No language model.',
    icon: 'assistant',
    route: '/dashboard/assistant',
    accent: '#fff0e8',
    ring: '#e8a88c',
    showInNav: true,
    hint: 'Keyword answers about your wedding',
  }),
  new AppModule({
    id: 'crew',
    code: null,
  ...
  new AppModule({
    ...
    tagline: 'Random Forest + Sri Lankan vendor line-item engine',
    description: 'Full LKR estimate from your wedding form — custom amounts, RSVP guest count, and a saveable cost breakdown.',
    icon: 'ai',
    tone: 'sage',
    smartHighlight: true,
  }),
  new AppModule({
    ...
    code: 'M09',
    name: 'Vendor Match',
    tagline: 'District · category · budget · ceremony type',
    description: 'Vendors ranked by district, budget, and ceremony — Poruwa, church, Hindu, or Nikah. Rule-based, not ML.',
    icon: 'sparkle',
    tone: 'sage',
    smartHighlight: true,
  }),
  new AppModule({
    ...
    code: 'M11',
    name: 'Smart Seating',
    tagline: 'KMeans clustering + guest-group constraints',
    description: 'Auto-seat Coming guests by family, friends, and VIP groups. Override any seat or download a printable Find Your Seat chart.',
    icon: 'seating',
    tone: 'sage',
    smartHighlight: true,
  }),
  new AppModule({
    ...
    tagline: 'Checklist 40% · RSVPs 35% · Budget 25%',
    description: 'Checklist 40% + RSVPs 35% + budget 25%. Green, yellow, or red status on your dashboard and Analytics.',
    icon: 'readiness',
    tone: 'sage',
    smartHighlight: true,
  }),
  ...
  new AppModule({
    ...
    code: 'M08',
    name: 'Bookings',
    tagline: 'Calendar, accept, reject, or counter-offer booking requests',
    description: 'Booking flow: Pending → Confirmed → Paid. Calendar availability, negotiate, and budget update on hire.',
    icon: 'calendar',
