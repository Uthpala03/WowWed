"""Feature encoding for WowWed cost tier prediction."""
...
TIER_RANGES = {
    "budget": {
        "min_total_lkr": 25000,
        "max_total_lkr": 499999,
        "label": "Budget",
    },
    "mid": {
        "min_total_lkr": 500000,
        "max_total_lkr": 1999999,
        "label": "Mid-range",
    },
    "premium": {
        "min_total_lkr": 2000000,
        "max_total_lkr": 5999999,
        "label": "Premium",
    },
    "luxury": {
        "min_total_lkr": 6000000,
        "max_total_lkr": 15000000,
        "label": "Luxury",
    },
}
...
def row_from_input(data):
    ...
    vendor_rating = float(data.get("vendor_rating") or data.get("rating") or 4.0)
    vendor_rating = round(max(1.0, min(vendor_rating, 5.0)), 1)
